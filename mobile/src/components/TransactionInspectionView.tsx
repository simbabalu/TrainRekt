...
const styles = StyleSheet.create({
  ...
  instructionBlock: { gap: Spacing.xs, marginBottom: Spacing.xs },
  ...
  transferDirection: { color: Colors.secondaryText, fontSize: Typography.label, fontWeight: '900', marginTop: Spacing.xs, minWidth: 30 },
  transferCopy: { flex: 1 },
  ...
  changeBlock: { borderTopColor: Colors.border, borderTopWidth: 1, gap: Spacing.xs, paddingTop: Spacing.sm },
