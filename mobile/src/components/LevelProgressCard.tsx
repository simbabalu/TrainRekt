...
const styles = StyleSheet.create({
  heading: { alignItems: 'flex-end', flexDirection: 'row', justifyContent: 'space-between', marginBottom: Spacing.md },
  ...
  remaining: { color: Colors.secondaryText, fontSize: Typography.small, marginTop: Spacing.sm },
});